...
local function CreateFlyControlButtons()
    ...
    FlyControlFrame.Size = UDim2.new(0, 140, 0, 220)
    FlyControlFrame.Position = UDim2.new(1, -155, 0.5, -110)
    FlyControlFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 25)
    FlyControlFrame.BackgroundTransparency = 0.15
    ...
    title.ZIndex = 51
    title.Parent = FlyControlFrame

    -- UP Button
    local UpBtn = Instance.new("TextButton")
    UpBtn.Name = "FlyUp"
    UpBtn.Size = UDim2.new(0.8, 0, 0, 70)
    UpBtn.Position = UDim2.new(0.1, 0, 0, 40)
    UpBtn.BackgroundColor3 = Color3.fromRGB(40, 180, 90)
    UpBtn.Text = "▲ UP"
    ...
    DownBtn.Size = UDim2.new(0.8, 0, 0, 70)
    DownBtn.Position = UDim2.new(0.1, 0, 0, 120)
    DownBtn.BackgroundColor3 = Color3.fromRGB(200, 80, 40)
    DownBtn.Text = "▼ DOWN"
    ...
    speedLabel.Position = UDim2.new(0, 0, 1, -22)
    ...
    UpBtn.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch or
           input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            UpBtn.BackgroundColor3 = Color3.fromRGB(70, 230, 130)
            UpBtn.Size = UDim2.new(0.82, 0, 0, 72)
            UpBtn.Position = UDim2.new(0.09, 0, 0, 39)
        end
    end)
    ...
    DownBtn.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch or
           input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            DownBtn.BackgroundColor3 = Color3.fromRGB(255, 120, 70)
            DownBtn.Size = UDim2.new(0.82, 0, 0, 72)
            DownBtn.Position = UDim2.new(0.09, 0, 0, 119)
        end
    end)
...
local FlightTog = MainTab:AddToggle("Fly Hack", "fly_hack", function(v)
    ...
    if v then
        if IsAndroid then
            Xan.Notify({
                Title = "Flight",
                Content = "Use o joystick para mover + botões ▲/▼ para subir/descer",
                Type = "Success"
            })
        else
            Xan.Notify({
                Title = "Flight",
                Content = "WASD para mover, A/D lateral, E/Space subir, Q/Shift descer",
                Type = "Success"
            })
        end
    end
    ...
    if Config.Fly then
        ...
        if BodyVel and BodyGyro then
            ...
            if FlySpeedLabel then
                pcall(function()
                    FlySpeedLabel.Text = "Speed: " .. math.floor(Config.FlySpeed)
                end)
            end
        end
    else
