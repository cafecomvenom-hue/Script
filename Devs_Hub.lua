...
local function CreateAndroidButtons()
    ...
    local buttonConfigs = {
        {Name = "FlyBtn", Pos = UDim2.new(0, 10, 0.5, -25), Color = Color3.fromRGB(0, 150, 255), Size = 50},
        {Name = "SpeedBtn", Pos = UDim2.new(0, 10, 0.6, -25), Color = Color3.fromRGB(0, 200, 0), Size = 50},
        {Name = "AimBtn", Pos = UDim2.new(0, 10, 0.4, -25), Color = Color3.fromRGB(255, 0, 0), Size = 50},
        {Name = "EspBtn", Pos = UDim2.new(0, 10, 0.7, -25), Color = Color3.fromRGB(255, 200, 0), Size = 50},
        {Name = "TeleBtn", Pos = UDim2.new(0.9, -50, 0.5, -25), Color = Color3.fromRGB(150, 0, 255), Size = 50},
        {Name = "UpBtn", Pos = UDim2.new(0.5, -50, 0.15, -50), Color = Color3.fromRGB(100, 200, 100), Hidden = true, Size = 100},
        {Name = "DownBtn", Pos = UDim2.new(0.5, -50, 0.28, -50), Color = Color3.fromRGB(200, 100, 100), Hidden = true, Size = 100},
    }
...
Connections["Loop"] = RunService.Stepped:Connect(function()
    ...
    if Config.Fly then
        ...
        if not IsAndroid then
            ...
            -- ===== MOBILE CONTROLS - MODO TAPETE MÁGICO =====
            -- SÓ VOA QUANDO O ANALÓGICO É MEXIDO
            if hum and hum.MoveDirection.Magnitude > 0 then
                -- Movimento detectado no analógico padrão
                local moveDir = hum.MoveDirection
                moveDirection = (Camera.CFrame.RightVector * moveDir.X) + (Camera.CFrame.LookVector * moveDir.Z)
            else
                -- Sem movimento no analógico = sem movimento no ar
                moveDirection = Vector3.zero
            end
            
            -- Controle vertical: APENAS com os botões UP/DOWN
    ...
    for _, btn_data in pairs(TouchButtons) do
        ...
        if name == "FlyBtn" then
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                -- Mostrar/ocultar botões UP e DOWN
                for _, btn_info in pairs(TouchButtons) do
                    if btn_info.Name == "UpBtn" or btn_info.Name == "DownBtn" then
                        btn_info.Button.Visible = Config.Fly
                    end
                end
        ...
        elseif name == "SpeedBtn" then
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                Xan.Notify({Title = "Speed", Content = Config.SpeedHack and "Ativado" or "Desativado"})
            end)
        ...
        elseif name == "AimBtn" then
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                Xan.Notify({Title = "Aimlock", Content = Config.Aimlock and "Ativado" or "Desativado"})
            end)
        ...
        elseif name == "EspBtn" then
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                Xan.Notify({Title = "ESP", Content = Config.ESP and "Ativado" or "Desativado"})
            end)
        ...
        elseif name == "TeleBtn" then
            ...
            btn.MouseButton1Click:Connect(function()
                if Config.TargetPlr and Config.TargetPlr.Character then
                    ...
                    Xan.Notify({Title = "Teleport", Content = "Para: " .. Config.TargetPlr.Name})
                else
                    Xan.Notify({Title = "Teleport", Content = "Nenhum alvo selecionado!", Type = "Error"})
                end
            end)
