...
local function CreateFlyControlButtons()
    ...
    -- Ícone do avião no topo (indicador)
    ...
    -- Seta UP (triângulo com TextLabel)
    ...
    -- Conexões UP com feedback visual suave
    ...
    -- Conexões DOWN com feedback visual suave
